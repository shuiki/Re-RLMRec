...
class AutoCF_plus_moe(BaseModel):
    def __init__(self, data_handler):
        super(AutoCF_plus_moe, self).__init__(data_handler)
        ...
        # self.hea = HEA(share_expt_num, spcf_expt_num, [hidden_dim, self.embedding_size], 2, self.usrprf_embeds.shape[1],
        #                dropout)
    ...
    def cal_loss(self, batch_data, encoder_adj, decoder_adj):
        ...
        ancprf_embeds = self.usrprf_embeds[ancs]
        posprf_embeds = self.itmprf_embeds[poss]
