...
from models.base_model import MLP,HEA
...
class SGL_plus(LightGCN):
    def __init__(self, data_handler):
        ...
        self.hea = HEA(share_expt_num, spcf_expt_num,
                       [((self.usrprf_embeds.shape[1] + self.embedding_size) // 2), self.embedding_size], 2,
                       self.usrprf_embeds.shape[1], dropout)
    ...
    def cal_loss(self, batch_data):
        ...
        ancprf_embeds, posprf_embeds, negprf_embeds = self._pick_embeds(self.usrprf_embeds, self.itmprf_embeds,
                                                                        batch_data)
