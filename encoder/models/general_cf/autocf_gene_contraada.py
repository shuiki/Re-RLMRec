...
from models.loss_utils import reg_params, cal_infonce_loss, ssl_con_loss

init = nn.init.xavier_uniform_
uniformInit = nn.init.uniform

class AutoCF_gene_contraAda(BaseModel):
    def __init__(self, data_handler):
        super(AutoCF_gene_contraAda, self).__init__(data_handler)
